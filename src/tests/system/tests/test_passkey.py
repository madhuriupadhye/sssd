...
FIDO2 key is connected physically.
This could be su, login, the GUI, or even ssh @localhost. 
Here, passkey support is tested with su, 
tests are running with umockdev, not with any physically key.
"""
